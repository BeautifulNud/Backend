...
//    boolean existsByAddress_IdAndDateAndScheduleState(Long addressId, LocalDate date, ScheduleState scheduleState);
    ...
    Page<SubscriptionSchedule> findAllBySubscription_Order_Item_NameAndSubscription_User_EmailAndScheduleState
            (String name, String email, ScheduleState scheduleState, Pageable pageable);
