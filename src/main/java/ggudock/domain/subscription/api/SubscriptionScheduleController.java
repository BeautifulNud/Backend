...
public class SubscriptionScheduleController {
    ...
    @GetMapping("/all")
    public ResponseEntity<Page<SubscriptionScheduleResponse>> getSubscriptionDatePage(@RequestParam(value = "page", defaultValue = "0") int page, Authentication authentication) {
        return new ResponseEntity<>(subscriptionScheduleService.getSubscriptionSchedulePage(SecurityUtil.getCurrentName(authentication), page), HttpStatusCode.valueOf(200));
    }
    ...
    public ResponseEntity<Page<SubscriptionScheduleResponse>> getSubscriptionDatePageByDay(@RequestParam("day") List<DayOfWeek> day,
        ...
        return new ResponseEntity<>(subscriptionScheduleService.getSubscriptionSchedulePageByDayList(day, SecurityUtil.getCurrentName(authentication), state, page)
    ...
    public ResponseEntity<Page<SubscriptionScheduleResponse>> getSubscriptionDatePageByDate(@RequestParam("date") List<LocalDate> date,
                                                                                            ...
                                                                                            @RequestParam(value = "page", defaultValue = "0") int page,
                                                                                            Authentication authentication) {
        return new ResponseEntity<>(subscriptionScheduleService.getSubscriptionSchedulePageByDates(date, SecurityUtil.getCurrentName(authentication), state, page),
                HttpStatusCode.valueOf(200));
    }
    ...
    public ResponseEntity<Page<SubscriptionScheduleResponse>> getSubscriptionDatePageByDates(@RequestParam("start") LocalDate start,
                                                                                             ...
                                                                                             @RequestParam(value = "page", defaultValue = "0") int page,
                                                                                             Authentication authentication) {
        return new ResponseEntity<>(subscriptionScheduleService.getSubscriptionSchedulePageByDates(start, end, SecurityUtil.getCurrentName(authentication), state, page),
                HttpStatusCode.valueOf(200));
    }
    ...
    public ResponseEntity<Page<SubscriptionScheduleResponse>> getSubscriptionDatePageByTitle(@RequestParam("title") String title,
                                                                                             ...
                                                                                             @RequestParam(value = "page", defaultValue = "0") int page,
                                                                                             Authentication authentication) {
        return new ResponseEntity<>(subscriptionScheduleService.getSubscriptionSchedulePageByTitle(title, SecurityUtil.getCurrentName(authentication), state, page),
                HttpStatusCode.valueOf(200));
    }
    ...
    public ResponseEntity<Page<SubscriptionScheduleResponse>> getSubscriptionScheduleBySubscription(@RequestParam("subscriptionId") Long subscriptionId,
                                                                                                    ...
                                                                                                    @RequestParam(value = "page", defaultValue = "0") int page,
                                                                                                    Authentication authentication) {
        return new ResponseEntity<>(subscriptionScheduleService.getSubscriptionScheduleBySubscription(subscriptionId, SecurityUtil.getCurrentName(authentication), state, page),
                HttpStatusCode.valueOf(200));
    }
    ...
    public ResponseEntity<Page<SubscriptionScheduleResponse>> getSubscriptionScheduleByState(@RequestParam("state") ScheduleState state,
                                                                                             @RequestParam(value = "page", defaultValue = "0") int page,
                                                                                             Authentication authentication) {
        return new ResponseEntity<>(subscriptionScheduleService.getSubscriptionScheduleByState(SecurityUtil.getCurrentName(authentication), state, page),
                HttpStatusCode.valueOf(200));
    }
}