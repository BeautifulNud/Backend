...
public class SubscriptionController {
    ...
    public ResponseEntity<?> saveSubscriptionByPeriod(@Valid @RequestBody SubscriptionPeriodRequest subscriptionRequest,
        ...
        if (subscriptionService.saveSubscriptionByPeriod(subscriptionRequest, SecurityUtil.getCurrentName(authentication), addressId, itemId)) {
    ...
    public ResponseEntity<?> saveSubscriptionByDay(@Valid @RequestBody SubscriptionDayRequest subscriptionRequest,
                                                   ...
                                                   @PathVariable("itemId") Long itemId,
                                                   Authentication authentication) {
        if (subscriptionService.saveSubscriptionByDay(subscriptionRequest, SecurityUtil.getCurrentName(authentication), addressId, itemId)) {
            return new ResponseEntity<>(Map.of("message", "해당 날짜에 해당 배송지에 대한 예약이 있습니다."), HttpStatusCode.valueOf(200));
        } else {
            return new ResponseEntity<>(null, HttpStatusCode.valueOf(204));
        }
    ...
    public ResponseEntity<Page<SubscriptionResponse>> getSubscriptionPageByOn(@RequestParam(value = "page", defaultValue = "0") int page, Authentication authentication) {
    ...
    public ResponseEntity<Page<SubscriptionResponse>> getSubscriptionPageByOff(@RequestParam(value = "page", defaultValue = "0") int page, Authentication authentication) {
    ...
    public ResponseEntity<Page<SubscriptionResponse>> getSubscriptionPageByPeriod(@RequestParam(value = "page", defaultValue = "0") int page, Authentication authentication) {
    ...
    public ResponseEntity<Page<SubscriptionResponse>> getSubscriptionPageByDay(@RequestParam(value = "page", defaultValue = "0") int page, Authentication authentication) {
    ...
    public ResponseEntity<Page<SubscriptionResponse>> getDaySubscriptionPage(@RequestParam("title") String title,
                                                                             ...
                                                                             Authentication authentication) {
        return new ResponseEntity<>(subscriptionService.getSubscriptionPageByTitle(title, SecurityUtil.getCurrentName(authentication), page), HttpStatusCode.valueOf(200));
    }
}
